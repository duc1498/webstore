            ...
            <div class="col-md-12">
                <div class="box">
                        ...
                        <table class="table table-bordered">
                            ...
                            @foreach ($category as $key => $item)
                                <tr class="item-{{ $item->id }}">
                                    ...
                                    <td>
                                        <a href="{{ route('admin.category.edit', ['category' => $item->id]) }}"><span
                                                title="Chỉnh sửa" type="button" class="btn btn-flat btn-primary"><i
                                                    class="fa fa-edit"></i></span></a>
                                        @if ($item->deleted_at == null)
                                            <span data-id="{{ $item->id }}"
                                                data-url="{{ route('admin.category.destroy', $item->id) }}" title="Xóa"
                                                class="btn btn-flat btn-danger deleteItem"><i
                                                    class="fa fa-trash"></i></span>
                                        @else
                                            <span data-id="{{ $item->id }}"
                                                data-url="{{ route('admin.category.restore', $item->id) }}"
                    ...
                    <div class="box-footer clearfix">
                        {{ $category->links('backend.layouts.pagination') }}
